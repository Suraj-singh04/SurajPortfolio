    ...
    return (
      <motion.button
        ...
        className={cn(
          ...
          "border-(--color-border) bg-(--color-card) text-(--color-foreground)",
          "hover:scale-105 hover:bg-(--color-muted) active:scale-95",
          sizeClasses[size],
          className
        )}
                    ...
                    className={cn(
                      ...
                      size === "sm"
                        ...
                        : size === "md"
                          ...
                          : "h-12 w-12",
                      isSelected
                        ? "scale-125 border-(--color-primary) bg-(--color-primary) text-white"
                        : "border-(--color-border) bg-(--color-card) text-(--color-foreground)"
                    )}
                    style={{
